...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWNocmFmZWxoMjIiLCJhIjoiY2tjdnJwNzUzMDcydDJxbXNxb3AwOHBmMCJ9.HA9efmxCWSxYHwg5braOEg';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Exented map bounds to include current location
...
var stripe = Stripe('pk_test_EcVV9JSHwf98bj5W0w41JD7G00CYOmmUrQ');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2) Create checkout and charge credit card
